...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "8fe88a72-84b2-4a1a-9032-6fde3f97425b"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("REALITY_PORT", "20129");       // reality节点(tcp协议)端口，支持多端口可以填写，否则留空
